...
<Line {offset} line={"It is time for us to reclaim,"}>
    <ParallaxLayer {offset} rate={0.5} {onProgress}>
        <div class="relative top-[55%] aspect-square w-full overflow-hidden">
            <div style="--tw-scale-x: {personScale}; --tw-scale-y: {personScale};  --tw-translate-x: {-personPosition - 50}%;" class="absolute left-1/2 top-1/2 aspect-square w-[7%] -translate-y-1/2 rounded-full bg-white" />

            <div style="--tw-scale-x: {personScale}; --tw-scale-y: {personScale}; --tw-translate-x: {personPosition - 50}%;" class="absolute left-1/2 top-1/2 aspect-square w-[7%] -translate-y-1/2 rounded-full bg-white" />

            <div style="--tw-scale-x: {explosionScale}; --tw-scale-y: {explosionScale};" class="absolute left-1/2 top-1/2 aspect-square w-[50%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-100 blur-xl" />
        </div>
    </ParallaxLayer>
</Line>
